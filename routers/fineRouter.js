...
const FineController = require("../controllers/booksControllers");
...
router.route("/adminmenu/addFine").post(Auth,FineController.addFine);
router.route("/adminmenu/editFine/:stu_Id").get(Auth,bookController.editBook);
